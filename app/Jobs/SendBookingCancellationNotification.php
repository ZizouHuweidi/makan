...
class SendBookingCancellationNotification implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Log::info('Booking cancellation notification', [
        ...
        // Mail::to($booking->guest->email)->send(new BookingCancellationMail($booking));
        // Mail::to($booking->listing->host->email)->send(new BookingCancelledNotificationMail($booking));
    }
}
